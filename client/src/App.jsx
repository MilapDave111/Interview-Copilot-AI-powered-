          ...
          <div className="mt-8 p-6 bg-slate-800 rounded-xl shadow-2xl w-full max-w-2xl border border-slate-700 animate-fade-in">
            ...
            <div className="flex items-center justify-between mb-6 border-b border-slate-600 pb-4">
              ...
              <div className={`px-4 py-2 rounded-full font-bold text-xl ${
                analysis.score >= 7 ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"
              }`}>
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className={`font-bold px-2 py-0.5 rounded text-sm ${
                      item.json_log.analysis.score >= 7 ? "bg-green-900 text-green-300" : "bg-red-900 text-red-300"
                    }`}>
